...
$cek = mysqli_query($con,"SELECT * from tabel_absen_kehadiran_guru where id_guru = '$id_guru' and tgl = '$tgl'");
...
if ($c == 0) {
    ...
    if (strtotime($jam) <= strtotime($sampai)) {
        mysqli_query($con,"INSERT INTO tabel_absen_kehadiran_guru VALUES ('','$id_guru','$tgl','$jam','')");
