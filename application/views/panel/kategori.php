  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="kategori/save" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputEmail3" required placeholder="Remarks" name="remarks">
                  </div>
                </div>        
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="kategori/process" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">Remarks *</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" required id="remarks" value="<?php echo $row->remarks ?>" placeholder="Remarks" name="remarks">
                  </div>
                </div>     
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hovered">
          ...
          echo "          
            <tr>
              <td><input type='checkbox' class='data-check' value='$row->id_kategori'></td>            
              <td>$no</td>              
              <td>$row->nama</td>
              <td>$row->remarks</td>
              <td>";
              ?>
                <form method="post" action="kategori/process">
    ...
    if(confirm('Are you sure delete this '+list_id.length+' data?'))
      {
        $.ajax({
          type: "POST",
          data: {id:list_id},
          url: "<?php echo site_url('kategori/ajax_bulk_delete')?>",
          dataType: "JSON",
